import { toggleLabel } from './labelFilterSlice';
    ...
    return (
        <>  
            <div className={`filters-container${filterMenu ? "" : "-hidden"}`} id="filter">
                    {filterMenu ? (
                        <div className={`filters-container-wrap${sticky ? "-sticky" : ""}`}>
                    ...
                    <div className= {`filter-toggle-button${filterMenu ? "-small" : ""}`} id="main-toggle-button"
